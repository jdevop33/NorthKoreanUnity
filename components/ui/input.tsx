...
// Use React.InputHTMLAttributes directly instead of defining an empty extending interface
const Input = React.forwardRef<
  HTMLInputElement, 
  React.InputHTMLAttributes<HTMLInputElement> // Use React type directly
>(
