...
// Use React.TextareaHTMLAttributes directly instead of defining an empty extending interface
const Textarea = React.forwardRef<
  HTMLTextAreaElement, 
  React.TextareaHTMLAttributes<HTMLTextAreaElement> // Use React type directly
>(
  ({ className, ...props }, ref) => {
    return (
      <textarea
