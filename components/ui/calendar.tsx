...
function Calendar({
  ...
  ...props // Spread remaining props (including locale, etc.)
}: CalendarProps) {
  ...
  return (
    <DayPicker
      ...
      // Using PascalCase Icon keys for v9 + proper typing to avoid any
      components={{
        ...
        Dropdown: (dropdownProps: DropdownProps) => { 
          ...
          // Define year range directly, removing deprecated props usage
