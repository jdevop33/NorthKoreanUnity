...
// Removed `actionTypes` const - Use string literals directly in the reducer/dispatch
// const actionTypes = {
//   ADD_TOAST: "ADD_TOAST",
...
// Define Action types using string literals directly
type Action =
  | {
      type: "ADD_TOAST"
      toast: ToasterToast
...
export const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    default: // Optional: Add default case for exhaustive check
      return state
  }
}
...
function toast({ ...props }: Toast) {
  ...
  dispatch({
    ...
    toast: {
      ...
      id,
      open: true,
      // Add boolean type for open parameter
