export default function Header() {
  return (
    <header className="relative">
      <div className="absolute inset-0 bg-linear-to-b from-black/70 to-black/30 z-10"></div>
      <img 
      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-white px-6">
        ...
        <p className="text-lg md:text-xl max-w-2xl text-center font-light leading-relaxed shadow-xs">
