      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:mb-0">
            <h3 className="font-serif-kr text-xl font-medium mb-4 text-text-light">조선 문화유산</h3>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-text-light text-sm">
          ...
          <p className="mt-2">
            <a href="#" className="hover:text-accent-gold transition-colors duration-200">이용약관</a> · 
            <a href="#" className="hover:text-accent-gold transition-colors duration-200 mx-2">개인정보처리방침</a> · 
            <a href="#" className="hover:text-accent-gold transition-colors duration-200">연락처</a>
          </p>
        </div>
      </div>
    </footer>
